...
class ColorPicker extends WatchUi.Picker {
    ...
    public function initialize() {
        var title = new WatchUi.Text({
            :text => $.Rez.Strings.colorPickerTitle,
        ...
        var nextArrow = new WatchUi.Bitmap({
            :rezId => $.Rez.Drawables.nextArrow,
            :locX => WatchUi.LAYOUT_HALIGN_CENTER,
            :locY => WatchUi.LAYOUT_VALIGN_CENTER,
        });
        var previousArrow = new WatchUi.Bitmap({
            :rezId => $.Rez.Drawables.previousArrow,
            :locX => WatchUi.LAYOUT_HALIGN_CENTER,
            :locY => WatchUi.LAYOUT_VALIGN_CENTER,
        });
        var brush = new WatchUi.Bitmap({
            :rezId => $.Rez.Drawables.brush,
            :locX => WatchUi.LAYOUT_HALIGN_CENTER,
            :locY => WatchUi.LAYOUT_VALIGN_CENTER,
        });
        Picker.initialize({
