    ...
    public function onMenu() as Boolean {
        if (WatchUi has :NumberPicker) {
            if (_count == 0) {
                ...
                var value = 1000f;
                var np = new WatchUi.NumberPicker(
                    WatchUi.NUMBER_PICKER_DISTANCE,
                    value
                );
                WatchUi.pushView(
                    np,
                    new $.PickerDelegate(_view),
                ...
                var value = Time.Gregorian.duration({
                    :hours => 9,
                    :minutes => 8,
                    :seconds => 10,
                });
                ...
                var value = 200;
                var np = new WatchUi.NumberPicker(
                    WatchUi.NUMBER_PICKER_CALORIES,
                    value
                );
                WatchUi.pushView(
                    np,
                ...
                var value = 1980;
                var np = new WatchUi.NumberPicker(
                    WatchUi.NUMBER_PICKER_BIRTH_YEAR,
                    value
                );
                WatchUi.pushView(
                    np,
